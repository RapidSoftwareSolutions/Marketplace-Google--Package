...
$app->post('/api/GooglePlus/getComment', function ($request, $response) {
    ...
    $validateRes = $checkRequest->validate($request, ['commentId','accessToken']);
    ...
    $url = "https://www.googleapis.com/plus/v1/comments/";
    ...
    $url = $url.$queryParam['commentId'];
    unset($queryParam['commentId']);
