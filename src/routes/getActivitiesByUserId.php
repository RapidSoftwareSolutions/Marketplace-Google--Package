...
$app->post('/api/GooglePlus/getActivitiesByUserId', function ($request, $response) {
    ...
    $validateRes = $checkRequest->validate($request, ['userId','accessToken',"collection"]);
    ...
    $url = $url.$queryParam['userId'].'/activities/'.$queryParam['collection'];
    unset($queryParam['userId']);
    unset($queryParam['collection']);
